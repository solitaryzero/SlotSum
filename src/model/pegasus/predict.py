...
def main(params):
    ...
    def init_model():
        model = PegasusForConditionalGeneration.from_pretrained(params['model_path'])
        if (params['cuda']):
            model = model.to('cuda')
        return model
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='./models/pegasus')
    parser.add_argument('--output_path', type=str, default='./data/slotsum/pegasus_prediction')
