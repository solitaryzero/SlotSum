...
def main(params):
    ...
    def tokenize_function(examples):
        sloted_text = examples['sloted_text']
        ...
        inputs = []
        for s, k in zip(sloted_text, kvs):
            inputs.append([k, s])
    ...
    eval_result = trainer.evaluate(max_length=params['res_max_length'])
    print(eval_result)
    metrics = eval_result
...
if __name__ == "__main__":
    ...
    # data paths
    parser.add_argument('--data_path', type=str, default='./data/slotsum/rewriter')
    parser.add_argument('--model_path', type=str, default='./models/rewriter')
