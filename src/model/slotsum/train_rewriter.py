...
# import wandb
# wandb.init(project="slotsum-rewriter")
...
def main(params):
    ...
    def tokenize_function(examples):
        if (params['mode'] == 'template'):
            input_text = examples['sloted_text']
        else:
            input_text = examples['source_text']
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_path', type=str, default='./models/slotsum_rewriter')
