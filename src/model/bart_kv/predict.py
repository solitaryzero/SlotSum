...
def main(params):
    ...
    predictions = trainer.predict(tokenized_dataset['test'], max_length=params['res_max_length'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='./models/raw_bart/bart-large')
    parser.add_argument('--output_path', type=str, default='./data/slotsum/bart_prediction')
